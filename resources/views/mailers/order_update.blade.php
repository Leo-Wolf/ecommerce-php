                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                Se ha actlizado la informacion de tu pedido, aqui estan los datos actualizados
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
													...
													<tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                                ...
                                                                <a href="mailto:ayuda@vekingo.com">ayuda@vekingo.com</a>
                                                            </div>
														</td>
                                                    </tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Ver más informacion de mi pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2017 Vekingo, All rights reserved.</em>
